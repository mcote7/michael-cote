      ...
      <div className="stats-wrap row">
        ...
        <div className="role-card col-lg-6">
          ...
          <div className="role-body">
            ...
            <div className="quote">
              <small>We are building secure business solutions using modern communication tools like video conferencing, live streaming and real-time screen sharing.</small>
            </div>
