...
const App = () => {
    ...
    useEffect(() => {
        ...
        root?.style.setProperty(
            "--text-color-primary",
            darkMode ? "rgba(255, 255, 255, 0.93)" : "rgba(0, 0, 0, 0.93)"
        );
        root?.style.setProperty(
    ...
    const [primaryColor, setPrimaryColor] = useState("#2978FF");
    ...
    useEffect(() => {
        ...
        if (colorMode === "green") {
            animateBulb();
            root?.style.setProperty("--primary", "#28C270");
            root?.style.setProperty("--primary-dark", "#219C59");
            root?.style.setProperty("--primary-light", "#6BDD90");
            setPrimaryColor("#28C270");
        ...
        if (colorMode === "orange") {
            animateBulb();
            root?.style.setProperty("--primary", "#FF163E");
            root?.style.setProperty("--primary-dark", "#C1163E");
            root?.style.setProperty("--primary-light", "#FF3E70");
            setPrimaryColor("#FF163E");
